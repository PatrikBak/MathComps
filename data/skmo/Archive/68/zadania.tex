...
{%%%%%   CPSJ, priklad t3
Nech $ABCD$ je konvexný štvoruholník s~kolmými uhlopriečkami, v~ktorom $\angle BAC=\angle ADB$, $\angle CBD=\angle DCA$, $AB=15$, $CD=8$. Ukážte, že štvoruholníku $ABCD$ možno opísať kružnicu a~určte vzdialenosť medzi stredom tejto kružnice a~priesečníkom uhlopriečok štvoruholníka. }
\podpis{Ján Mazák, Slovensko}
