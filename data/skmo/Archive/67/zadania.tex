...
{%%%%%   CPSJ, priklad t3
Určte všetky reálne čísla $r$ s~nasledujúcou vlastnosťou: Ak reálne čísla $a$, $b$, $c$ spĺňajú nerovnosť $|ax^2+bx+c|\le 1$ pre každé $x\in\langle-1,1\rangle$, tak spĺňajú tiež nerovnosť $|cx^2+bx+a|\leq r$ pre každé $x\in\langle-1,1\rangle$.
}
\podpis{Jaromír Šimša}

{%%%%%   CPSJ, priklad t4
Priamka prechádzajúca stredom $M$ rovnostranného trojuholníka $ABC$ pretína jeho strany $BC$ a $CA$ v~bodoch $D$ a $E$. Kružnice opísané trojuholníkom $AEM$ a $BDM$ sa okrem bodu~$M$ ďalej pretínajú v~bode $P$. Dokážte, že stred kružnice opísanej trojuholníku $DEP$ leží na osi úsečky $AB$.
}
...
{%%%%%   CPSJ, priklad t6
Kladné reálne čísla $a$, $b$ sú také, že $a^3+b^3=2$. Dokážte, že platí nerovnosť
$$
