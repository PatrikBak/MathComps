...
{%%%%%   CPSJ, priklad t1
Rozhodnite, či existujú prvočísla $p$, $q$, $r$ také, že
$$(p^2+p)(q^2+q)(r^2+r)$$
je druhou mocninou nejakého celého čísla.}
\podpis{Kamil Rychlewicz}

{%%%%%   CPSJ, priklad t2
Rozhodnite, či existuje konvexný šesťuholník, ktorého všetky strany majú dĺžky väčšie ako 1 a všetkých deväť jeho uhlopriečok má dĺžky menšie ako 2.}
\podpis{Vojtech Bálint}

{%%%%%   CPSJ, priklad t3
Koľko je 8-ciferných čísel v tvare ${*}2{*}0{*}1{*}7$, kde štyri neznáme cifry sú nahradené hviezdičkami, ktoré sú deliteľné $7$?}
\podpis{Peter Novotný}

{%%%%%   CPSJ, priklad t4
Bolek narysoval na tabuľu lichobežník $ABCD$ ($AB\parallel CD$) a~v~ňom jeho strednú priečku~$EF$. Priesečník jeho uhlopriečok $AC$, $BD$ označil~$P$, a~jeho kolmý priemet na priamku $AB$ označil~$Q$. Lolek, chcejúc Bolkovi urobiť napriek, zmazal z~tabule všetko okrem úsečiek $EF$ a~$PQ$. Keď to Bolek uvidel, chcel doplniť obrázok a~dorysovať pôvodný lichobežník, ale nevedel, ako to urobiť. Viete pomôcť Bolkovi?}
