...
{%%%%%   CPSJ, priklad t1
Majme lichobežník $ABCD$ so základňami $AB$ a $CD$, spĺňajúcimi $|AB|>|CD|$. Označme $M$ stred úsečky $AB$. Nech bod $P$ leží vnútri $ABCD$ a platí $|AD|=|PC|$ a~$|BC|=|PD|$. Dokážte, že ak $|\angle CMD|=90^\circ$, tak štvoruholníky $AMPD$ a $BMPC$ majú rovnaký obsah.}
\podpis{\L{}ukasz Bożyk, Poľsko}

{%%%%%   CPSJ, priklad t2
Majme dané čísla $x_i \in \{-1, 1\}$ pre $i = 1, 2, \ldots, n$, spĺňajúce
$$
x_1x_2+x_2x_3+\ldots+x_{n-1}x_n+x_nx_1=0.
$$
Dokážte, že $n$ je delite\l{}né $4$.}
\podpis{Jaroslav Švrček, Česká rep.}

{%%%%%   CPSJ, priklad t3
Určte počet dvojíc $(a,b)$ kladných celých čísel s~takou vlastnosťou, že najväčší spoločný delite\l{} čísel $a$ i~$b$ je rovný
$$
1\cdot 2\cdot 3\cdot\ldots\cdot 50,
$$
a najmenší spoločný násobok čísel $a$ i~$b$ je rovný
$$
...
{%%%%%   CPSJ, priklad t4
Určte najmenšie kladné celé číslo $n$ s~takou vlastnosťou, že v~množine
$$
\{70, 71, 72, \ldots, 70 + n\}
$$
možno nájsť dve rôzne čísla, ktorých súčin je štvorcom celého čísla.}
