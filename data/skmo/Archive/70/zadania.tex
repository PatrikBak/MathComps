...
{%%%%%   CPSJ, priklad t3
Určte počet dvojíc $(a,b)$ kladných celých čísel s~takou vlastnosťou, že najväčší spoločný deliteľ čísel $a$, $b$ je rovný
$$
1\cdot 2\cdot 3\cdot\ldots\cdot 50,
$$
a najmenší spoločný násobok čísel $a$, $b$ je rovný
$$
