...
{%%%%%   CPSJ, priklad t5
Na tabuli je na začiatku napísané číslo $1$. Ak je na tabuli napísané číslo $a$, tak na ňu môžeme napísať takisto prirodzené číslo $b$ také, že $a+b+1$ je deliteľom čísla $a^2+b^2+1$. Rozhodnite, či sa na tabuli po istom čase môže objaviť ktorékoľvek vopred dané prirodzené číslo. Svoju odpoveď zdôvodnite.
}
\podpis{Poľsko}
