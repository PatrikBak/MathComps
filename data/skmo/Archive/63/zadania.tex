...
{%%%%%   CPSJ, priklad t3
Nájdite všetky celé čísla $n$ s~takou vlastnosťou, že
$$
|n^3-4n^2+3n-35|\quad\text{a}\quad |n^2+4n+8|
$$
s\ú{} prvočíslami.}
\podpis{Česká rep.}

{%%%%%   CPSJ, priklad t4
Bod $M$ je stredom strany $AB$ ostrouhlého trojuholníka $ABC$. Kružnica so stredom v~bode $M$ prechádzajúca bodom $C$ pretína priamky $AC$ a~$BC$ druhýkrát postupne v~bodoch $P$ a~$Q$. Bod $R$ patriaci úsečke $AB$ je taký, že trojuholníky $APR$ a~$BQR$ maj\ú{} rovnaké obsahy. Dokážte, že priamky $PQ$ a~$CR$ s\ú{} kolmé.}
\podpis{Poľsko}

{%%%%%   CPSJ, priklad t5
Na tabuli je na začiatku napísané číslo $1$. Ak je na tabuli napísané číslo $a$, tak na ňu môžeme napísať takisto prirodzené číslo $b$ také, že $a+b+1$ je delite\l{}om čísla $a^2+b^2+1$. Rozhodnite, či sa na tabuli po istom čase môže objaviť ktoréko\l{}vek vopred dané prirodzené číslo. Svoju odpoveď zdôvodnite.
}
\podpis{Poľsko}

{%%%%%   CPSJ, priklad t6
Určte najväčšiu a najmenšiu hodnotu zlomku
   $$F={{y-x}\over{x+4y}},$$
ak reálne čísla $x$ a $y$ vyhovujú rovnici $x^2y^2+xy+1=3y^2$.
}
\podpis{Česká rep.}
