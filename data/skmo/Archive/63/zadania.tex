...
{%%%%%   CPSJ, priklad t4
Bod $M$ je stredom strany $AB$ ostrouhlého trojuholníka $ABC$. Kružnica so stredom v~bode $M$ prechádzajúca bodom $C$ pretína priamky $AC$ a~$BC$ druhýkrát postupne v~bodoch $P$ a~$Q$. Bod $R$ patriaci úsečke $AB$ je taký, že trojuholníky $APR$ a~$BQR$ majú rovnaké obsahy. Dokážte, že priamky $PQ$ a~$CR$ sú kolmé.}
\podpis{Poľsko}
