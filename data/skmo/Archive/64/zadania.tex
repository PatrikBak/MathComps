...
{%%%%%   CPSJ, priklad t3
Rôzne body $A$ a $D$ ležia na tej istej strane priamky $BC$, pričom $|AB| = |BC| = |CD|$ a priamky $AD$ a $BC$ s\ú{} kolmé. Nech $E$ je priesečník priamok $AD$ a $BC$. Dokážte, že
$$
...
{%%%%%   CPSJ, priklad t4
Nájdite všetky také dvojice $(a,b)$ kladných celých čísel, že
$$
a+b+(D(a,b))^2=n(a,b)= 2\cdot n(a-1,b),
$$
kde $n(a,b)$ označuje najmenší spoločný násobok, a $D(a, b)$ -- najväčší spoločný
delite\l{} čísel $a$, $b$.}
\podpis{Tomáš Jurík}

{%%%%%   CPSJ, priklad t5
Určte najmenšiu reálnu konštantu $p$, pre ktorú platí nerovnosť
$$
\sqrt{ab}-\frac{2ab}{a+b} \leq p\left(\frac{a+b}2-\sqrt{ab}\right)
$$
s \l{}ubovo\l{}nými kladnými reálnymi číslami $a$, $b$.
}
\podpis{Jaromír Šimša}

{%%%%%   CPSJ, priklad t6
Vrcholom kocky pripíšeme po jednom čísla $1,2,3,\dots ,8$ a každej jej hrane potom priradíme súčin čísel pripísaných jej
dvom krajným bodom. Určte najväčšiu možnú hodnotu súčtu čísel priradených všetkým dvanástim hranám kocky.
}
\podpis{Jaromír Šimša}