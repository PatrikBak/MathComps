...
{%%%%%   Z5-II-1
Na obrázku je trinásť geometrických útvarov, z ktorých niektoré sú rovnaké.
Do každého útvaru vpíšte jedno z čísel $1, 2, \dots, 9$ tak, aby v rovnakých útvaroch boli rovnaké čísla a~v~rôznych rôzne.

Aký najväčší a aký najmenší môže byť súčet čísel v útvaroch?
\insp{z5-ii-1.eps}%
}
\podpis{Miroslava Smitková}

{%%%%%   Z5-II-2
Vojtech a Pavol sa vážili spolu so svojím psom Brokom.
Zistili, že Brok váži $13$ kg, Pavol s Brokom vážia rovnako ako Vojtech a Vojtech spolu s Brokom váži dvakrát toľko ako Pavol.
...
{%%%%%   Z5-II-3
V obdĺžniku s rozmermi 808\,cm a 707\,cm sú do protiľahlých rohov vložené dva štvorce so stranami dĺžok 505\,cm a 404\,cm.
Každý zo štvorcov prilieha dvoma stranami k stranám obdĺžnika.
Štvorce sa prekrývajú v obdĺžniku, ktorý je na obrázku vyznačený sivou farbou.
...
Rodina si najskôr chcela kúpiť všetky štyri lístky v 10\,\%-tnej zľave. Nakoniec však pri kúpe skipasov mama využila 10\,\%-tnú zľavu a otec si spoločne s~deťmi kúpil rodinný lístok. Takto ich vyšli skipasy výhodnejšie.  Najmenej koľko mohol stáť nezľavnený lístok pre dospelého?
}
\podpis{Tomáš Bárta}

{%%%%%   Z9-II-2
Nájdite všetky štvorciferné prirodzené čísla s nasledujúcimi vlastnosťami:
\itemitem{$\bullet$} na mieste desiatok je cifra 5,
\itemitem{$\bullet$} po odstránení posledných dvoch cifier vznikne číslo, ktoré je $103$-krát menšie.
}
\podpis{Karel Pechouš}

{%%%%%   Z9-II-3
Prirodzené číslo nazveme {\it kockové\/}, ak jeho zápis obsahuje cifru alebo skupinu po sebe nasledujúcich cifier, ktorá je zápisom tretej mocniny kladného celého čísla.
(Napríklad čísla 279 a 729 sú kockové, čísla 297 a 792 nie.)
...
{%%%%%   Z9-II-4
V~trojuholníku $ABC$ je na strane $AB$ bod $D$, na strane $BC$ je bod $E$ a~bod $F$ je priesečník úsečiek $AE$ a~$CD$.
Obsahy trojuholníkov $ADF$, $AFC$ a~$CFE$ sú postupne 35\,cm$^2$, 70\,cm$^2$ a~20\,cm$^2$.
