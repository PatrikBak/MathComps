...
{%%%%%   CPSJ, priklad t3
Určte ve\l{}kosti vnútorných uhlov vo všetkých rovnoramenných trojuholníkoch, ktoré možno rozdeliť na dva rovnoramenné trojuholníky s~disjunktnými vnútorami. }
\podpis{Jaroslav Švrček}

{%%%%%   CPSJ, priklad t4
Ko\l{}ko je kladných celých čísel $n$ menších ako $2024$ a delite\l{}ných $\lfloor \sqrt{n}\rfloor-1$? Symbol $\lfloor x\rfloor$ označuje najväčšie celé číslo nie väčšie ako $x$.

\nopagebreak\smallskip\noindent
Napríklad $n=8$ spĺňa danú podmienku, keďže $8$ je delite\l{}né $\lfloor\sqrt{8}\rfloor-1=2-1=1$, ale $n=9$ ju nespĺňa, keďže $9$ nie je delite\l{}né $\lfloor \sqrt{9}\rfloor -1=2$.}
\podpis{Patrik Bak}
