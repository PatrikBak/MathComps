...
{%%%%%   CPSJ, priklad t1
Označme $S(n)$ súčet všetkých číslic prirodzeného čísla $n$. Určte všetky prirodzené čísla~$n$, pre ktoré sú obe čísla $n+S(n)$ a $n-S(n)$ druhými mocninami nenulových celých čísel.}
\podpis{Poľsko}

{%%%%%   CPSJ, priklad t2
Na tabuli sú napísané čísla $1,2,\ldots,2023$ v tomto poradí. Môžeme s nimi opakovane vykonávať nasledujúcu operáciu: Vyberieme ľubovoľný nepárny počet po sebe napísaných čísel a tieto čísla zapíšeme v~obrátenom poradí. Koľko rôznych poradí týchto $2023$ čísel tak môžeme dostať?

\emph{Príklad:} Ak začneme iba s číslami $1,2,3,4,5,6$, môžeme vykonávať nasledujúce kroky
...
{%%%%%   CPSJ, priklad t3
Na večierku sa stretlo $n$ osôb, pričom $n\geq 2$. Každá osoba nemá rada presne jednu inú osobu prítomnú na večierku (ale nie nevyhnutne so vzájomnosťou, t. j. môže sa stať, že $A$ má rád $B$ napriek tomu, že $B$ nemá rád $A$) a~má rada všetky ostatné. Ukážte, že hostí možno usadiť za tri stoly takým spôsobom, aby každý hosť mal rád všetky osoby pri svojom stole.}
\podpis{Poľsko}

{%%%%%   CPSJ, priklad t4
V trojuholníku $ABC$ sú body $M$ a~$N$ stredmi príslušných strán $AB$ a~$AC$. Osi vnútorných uhlov $ABC$ a $BCA$ pretínajú priamku $MN$ v bodoch $P$ a~$Q$. Nech $p$ je dotyčnica ku kružnici opísanej trojuholníku $AMP$ prechádzajúca bodom $P$ a~$q$ je dotyčnica ku kružnici opísanej trojuholníku $ANQ$ prechádzajúca bodom $Q$. Ukážte, že priamky $p$ a~$q$ sa pretínajú na priamke $BC$.}
\podpis{Michal Pecho}
