...
\EnvId{M_uB_nIoAD4XsWdDgD24w-number-plus-digit-product}
\Problem{0}{}{
...
\EnvId{QTZyuBlr4JJARL-BsUSPi-inflatable-two-digit-numbers}
\Problem{0}{}{
...
\EnvId{S9mOaQ0DZ0YbdtiJ0DD6M-digit-sum-12-block-difference}
\Problem{0}{}{
...
\EnvId{90DMgkLIpAKoLz31VbTyU-number-inserted-between-20-16}
\Problem{0}{}{
...
\EnvId{5o19zqbbgbsQ-mIyypy33-sum-of-digit-factorials}
\Problem{0}{}{
...
\EnvId{M2hAW0UhGrFFa9fvPlfq3-four-digit-square-aabb}
\Problem{0}{}{
...
\EnvId{KKh6fZHUhlmD5Z6MdjTkD-largest-prime-with-distinct-digits}
\Problem{0}{}{
...
\EnvId{thf_5gamTbDUYZ96i5eK6-even-digit-palindrome-and-11}
\Problem{0}{}{
...
\EnvId{oCrvA-6G_ng2beLVg_5Oc-repeated-digit-sum-of-concatenation}
\Problem{0}{}{
...
\EnvId{kPFhZbvWRNtc1_X52rp4J-digit-permutation-divisible-by-11}
\Problem{0}{}{
...
\EnvId{zyrVHB-UOHnAnwPbsWeQM-reverse-subtract-then-add}
\Problem{0}{}{
...
\EnvId{p_er0Qs-Y_iv3GxwWA_ie-removing-the-leading-six}
\Problem{0}{}{
...
\EnvId{cpOokCbzU9XKnq5Si294a-fours-eights-and-nine}
\Problem{0}{}{
...
\EnvId{HmZef6aCT19gonRzJndGH-last-digit-of-square}
\Problem{0}{}{
	A positive integer $n$ is given. Determine the last digit of the number $n^2$, given that the second-to-last digit of $n^2$ is~7.
}{
...
\EnvId{SiHIZXziGFRgQzQdb180j-rearranged-digits-of-powers-of-two}
\Problem{1}{}{
...
\EnvId{BbogXhbPaIvEP3zcKQo-l-odd-digits-power-of-five}
\Problem{1}{}{
...
\EnvId{42Uo2Y8305kh_-pQQuTML-appending-digits-and-composite-numbers}
\Problem{1}{}{
	Consider the following process: We start with an arbitrary positive integer $a_1$ and~generate a sequence $a_1,a_2,\dots$ so that we obtain $a_{n+1}$ by writing a digit different from~9 at the end of~$a_n$. Prove that this sequence will inevitably contain infinitely many composite numbers.
}{
...
\EnvId{3gPi6qLS_PwutgCgoS6zC-squares-in-base-four}
\Problem{2}{}{
