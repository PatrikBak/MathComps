...
\Subtitle{Introduction to Inequalities}
...
\Problem{1}{74-CSMO-A-II-1}{
    Given two distinct real numbers $a$, $b$ such that the expressions $a^3 + b$ and $a + b^3$ have the same value. Prove that for their product, $-1\le ab<\frac13$ holds.
}{
