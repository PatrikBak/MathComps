...
\EnvId{bPkLpBouOLKWsyJ2o4KB1-ordering-products-of-pairs}
\Example{}{
...
\EnvId{YZmrvYRhFg_8fHlZmZo3U-smallest-of-four-numbers}
...
\EnvId{P4XBmJZTYVy4KIe2BPqbE-cubes-with-nonnegative-sum}
\Example{}{
    ...
    \Answer{Equality occurs precisely when $a+b=0$ or $a=b$.}
...
\EnvId{JhZA_Dzle9gA4kV4lKv9q-sum-of-powers-of-two-positive-numbers}
\Exercise{}{
    ...
    \Answer{Equality occurs precisely when $a=b$.}
...
\EnvId{mQOwqNMi8OAFVITQ-pAYo-inequality-for-ordered-triple}
...
\EnvId{ED7SKfRlBMObihFgvGY7A-inequality-for-two-integers}
\Problem{0}{71-CSMO-C-II-1}{
    ...
    \Answer{Equality occurs precisely when $a=b$ or $b=a+1$.}
...
\EnvId{vQhiaK4eolSqnaAA9cuHZ-squares-versus-pairwise-products}
\Example{}{
...
\EnvId{418Wz9g6IWSugP49_tU-n-squares-plus-two}
\Exercise{}{
    ...
    \Answer{Equality occurs precisely for $x=y=1$.}
...
\EnvId{sdg3sRT7yvoIjDcMsErsE-quartic-terms-versus-product}
\Exercise{}{
    ...
    \Answer{Equality occurs precisely for $(a,b)=(0,0)$ or $(1,1)$.}
...
\EnvId{COs_bAdXRwGbPeWyYKM3R-equal-expressions-and-product-bounds}
...
\EnvId{m3P8RN63DfmSb-_H94B_n-closer-numbers-have-larger-product}
\Example{}{
...
\EnvId{hn826RYmOm1L-wYPENeAW-am-gm-inequality}
...
\EnvId{kAB49jcHXVg3uvkhrrteu-product-of-pairwise-sums}
\Example{}{
...
\EnvId{KMckvz9BRCkFpylMDM-ZQ-the-box-problem}
\Example{The Box Problem}{
    We have a square piece of paper with a side length of 12 cm. We want to create an open box by cutting identical squares from each of the four corners and folding up the sides. What is the largest possible volume of the box?

    \Image{box.pdf}
}{
    \Answer{The largest volume is $128$ (a $8 \times 8 \times 2$ box).}
...
\EnvId{Fetv2ZpBpdSAL9VRNj6Bo-power-and-linear-expression}
\Exercise{}{
...
\EnvId{LRZ7mn998YqvFEP_vggGc-numbers-with-product-one}
\Exercise{}{
...
\EnvId{7ptHVCux9v12DP7_YmSbY-sum-of-three-fractions}
\Exercise{}{
    Prove that for positive real numbers $a$, $b$, $c$, the inequality holds
    $$
...
\EnvId{5Y8zEyYvhLa8dN3Q2sEoF-four-numbers-with-reciprocals}
\Exercise{65-CSMO-A-S-2}{
    ...
    \Answer{The smallest value of $ab+cd$ is $2+2\sqrt{2}$.}
...
\EnvId{Y_rVM9PKRrNZ-xul7WWn5-implied-inequality-with-powers}
\Example{}{
...
\EnvId{lGgi2UDhTRt1I5AhB-CSX-squares-condition-and-product-inequality}
...
\EnvId{tM0NUHzGN7ISuNnwGlXCf-sum-greater-than-squares}
...
\EnvId{DQ2FUiK5hVPMXJL4mp2Pw-inequality-with-square-root}
\Problem{0}{}{
...
\EnvId{h9XOWPr4I6tWgzd33zXK0-product-of-squares-plus-one}
\Problem{0}{66-CPSJ-I-3}{
    ...
    \Answer{Equality occurs for $(x,y) \in \{(2,3),(3,2),(0,-1),(-1,0)\}$.}
...
\EnvId{He5FmTiAljgyhp8e3jrZT-squares-versus-last-term}
\Problem{0}{}{
...
\EnvId{nTrt8isVP7d-IkZLcxcKy-minimum-of-quartic-expression}
\Problem{0}{70-CPSJ-I-4}{
    ...
    \Answer{The smallest value is $-1/8$, at $x=y=1/2$.}
...
\EnvId{A8uKeAcwG40bQUQcsLUwV-condition-with-sixth-power}
