...
\Problem{0}{}{
    Let $ABC$ be an acute triangle. Outside it we construct rectangles $ABKL$ and $ACMN$ such that $BK = AC$ and $CM = AB$. Prove that the lines $BN$, $CL$ and $KM$ pass through a common point.
}{
...
\Problem{0}{Napoleon's theorem}{
    Points $D$, $E$, $F$ lie outside triangle $ABC$ so that the triangles $BCD$, $CAE$ and $ABF$ are equilateral. Prove that the centroids of these triangles also form an equilateral triangle.
}{
...
}%
{
    ...
    The rotation with center $A$ by $60^\circ$ mapping $F$ to $B$ maps $C$ to $E$ as well, because both triangles lie outside; therefore $CF = BE$. Likewise the rotation with center $C$ by $60^\circ$ maps $A$ to $E$ and $D$ to $B$, so $AD = BE$. Therefore $XY = YZ = ZX$ and the triangle $XYZ$ is equilateral.
}
...
\Problem{0}{ISL 1992}{
    Suppose the diagonals of a convex quadrilateral have equal length. Prove that if we erect mutually similar isosceles triangles outwardly on its sides, then the segments joining the apexes of the triangles on opposite sides are perpendicular to each other.
}{
