...
\i Define some nice-looking points that could clarify the situation or reveal something interesting about it (this is what we will practice in this handout~:) ).
...
\Problem{0}{Czech-Slovak Olympiad}{
...
\Problem{0}{}{
    Let $ABC$ be an acute triangle with midpoint~$M$ of side~$BC$. Let~$P \neq M$ be a point on side~$BC$. Denote by~$Q$ the midpoint of the arc~$AC$ not containing~$P$ of the circumcircle of~$APC$. Similarly, $R$ is the midpoint of the arc~$AB$ not containing~$P$ of the circumcircle of~$APB$. Prove that $\angle QMR=90^\circ$.
}{
