...
\EnvId{square-minus-one-cyclic-triple}
\Example{}{
    Metódou odčítania rovníc riešte sústavu v~množine reálnych čísel:
    $$
    \align
...
\EnvId{three-variable-square-mix}
...
\EnvId{square-plus-one-revisited}
\Example{}{
...
\EnvId{homogeneous-quadratic-triple}
\Example{}{
...
\EnvId{square-plus-shift-triple}
\Exercise{}{
...
\EnvId{square-equals-four-shift}
\Exercise{}{
...
\EnvId{common-sum-factor-triple}
\Exercise{}{
...
\EnvId{square-plus-one-once-more}
\Example{}{
...
\EnvId{absolute-difference-and-sum}
...
\EnvId{quintic-cubic-cyclic-triple}
\Exercise{}{
    Určte všetky trojice $(x,y,z)$ reálnych čísel, pre ktoré platí
    $$
    \align
...
\EnvId{quadratic-cross-term-triple}
...
\EnvId{cubic-quadratic-swap-pair}
...
\EnvId{absolute-value-cyclic-sum}
...
\EnvId{weighted-quadratic-cyclic-triple}
...
\EnvId{four-variable-cubic-cycle}
\Problem{0}{}{
    V~obore reálnych čísel riešte sústavu rovníc
    $$
    \align
