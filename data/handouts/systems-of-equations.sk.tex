...
Než začneme riešiť, tak jedna dôležitá praktická rada: Skúška -- vždy je dobré urobiť ju a~do riešenia napísať, že ste ju urobili. Častokrát je to oveľa rýchlejšie ako \textit{precízne} zdôvodniť, že ju spraviť netreba.  
...
\EnvId{D0LGFK_pfJGjGSaEZ_Hke-sustava-x2-plus-jedna}
\Example{}{
...
\EnvId{7z3zvIqJUW_wdFt8Zqo6w-trojica-x2-minus-jedna}
\Example{}{
    Metódou odčítania rovníc riešte sústavu v~množine reálnych čísel:
    $$
    \align
    ...
    \Answer{Päť trojíc: $(1+\sqrt2,1+\sqrt2,1+\sqrt2)$, $(1-\sqrt2,1-\sqrt2,1-\sqrt2)$, $(-1,0,0)$, $(0,-1,0)$ a~$(0,0,-1)$.}
...
\EnvId{BdBaRHPtT8T2Gs6oQNEgC-dvojica-x2-plus-xy}
\Exercise{}{
...
\EnvId{Ir2UYgurHXAHWW8PuMK7v-sucin-plus-sucet-je-tri}
\Exercise{}{
    Riešte sústavu rovníc v~obore reálnych čísel:
    $$
    \align
    ...
    \Answer{Dve riešenia: $(1,1,1)$ a~$(-3,-3,-3)$.}
...
\EnvId{J0N3G-MqiqTpPzm2xn-k1-dve-kvadraticke-rovnice-tri-nezname}
\Exercise{58. ročník, domáce B, úloha 2}{
    ...
    \Answer{Trojice $(t,t,t)$, $(t,0,t)$ a~$(t,0,-t)$ pre ľubovoľné reálne $t$.}
...
\EnvId{fJHAdZ9nOAf90RwGcVUgs-sustava-x2-plus-jedna-znova}
\Example{}{
...
\EnvId{SKm6_EEO8ktWY6GLAWFK3-mocniny-rovne-sucinom}
\Example{}{
    ...
    \Answer{Trojice $(t,t,t)$ pre ľubovoľné reálne $t$.}
...
\EnvId{ihFIU-Isi5rJX1DQF2FUp-a2-plus-b-cyklicka-sustava}
\Exercise{}{
...
\EnvId{b1Qku8TQk_bISQjaLLwJt-mocniny-rovne-stvornasobku}
\Exercise{}{
...
\EnvId{N916Q1M7Al6Ajy1bBzB67-nasobky-spolocneho-suctu}
\Exercise{}{
    ...
    \Answer{Dve riešenia: $(2,3,5)$ a~$(-2,-3,-5)$.}
...
\EnvId{BxI1A2IFhjVNRop0rnGmE-sustava-x2-plus-jedna-tretikrat}
\Example{}{
...
\EnvId{0P6L5xCu00XZL-YsyNO56-absolutna-hodnota-rozdielu-a-sucet}
...
\EnvId{hBqsEZLiptRWTxkNslZYy-tretie-mocniny-plus-jedna}
\Example{}{
    Riešte sústavu v~reálnych číslach:
    $$
    \align
    ...
    \Answer{Tri riešenia $(t,t,t)$, kde $t \in \{1, \frac12(-1\pm\sqrt5)\}$.}
...
\EnvId{FA9H6PMOIW_BIsrkdNyJz-dvojica-rovnic-s-odmocninami}
\Exercise{}{
    V~obore reálnych čísel riešte sústavu rovníc
    $$
    \align
...
\EnvId{Er1LlMMLgP86yG2Cwg-A3-piate-mocniny-suctu}
\Exercise{}{
    Určte všetky trojice $(x,y,z)$ reálnych čísel, pre ktoré platí
    $$
    \align
    ...
    \Answer{Tri riešenia: $(0,0,0)$, $(1,1,1)$ a~$(-1,-1,-1)$.}

    Sústava je symetrická, preto bez ujmy na všeobecnosti predpokladajme, že $x \ge y \ge z$. Potom aj $32x \ge 32y \ge 32z$, podľa sústavy teda máme      
    $$
    ...
    y+z \ge z+x \ge x+y,
    $$
    resp. $y \ge x$ z~prvej a~$z \ge y$ z~druhej. Spolu s~predpokladom $x \ge y \ge z$ to znamená $x=y=z$. Dosadením do prvej rovnice dostaneme $(2x)^5=32x$.
    $$
    32x^5-32x=0 \implies 32x(x^4-1)=0 \implies 32x(x-1)(x+1)(x^2+1)=0,
    $$
    takže (keďže $x^2+1>0$) $x=0$, $x=1$ alebo $x=-1$.

    Skúškou sa presvedčíme, že nájdené riešenia $(0,0,0)$, $(1,1,1)$ a~$(-1,-1,-1)$ naozaj vyhovujú.
}

\EnvId{wQlWW_d8RkEMYEVhPnUgM-piate-a-tretie-mocniny}
\Exercise{}{
    Určte všetky trojice $(x,y,z)$ reálnych čísel, pre ktoré platí
    $$
    \align
    ...
    \Answer{Päť riešení: $(0,0,0)$, $(1,1,1)$, $(-1,-1,-1)$, $(2,2,2)$ a~$(-2,-2,-2)$.}
...
\Remark Je veľa techník, ku ktorým sme sa nedostali -- najbežnejšia z~nich je využitie zložitejších nerovností. K~takýmto sústavám sa vrátime v~materiáli o~nerovnostiach.
...
\EnvId{J9y3n7IpfYrwv1MVEUpAH-kvadraticke-vyrazy-rovne-nule}
\Problem{0}{74. ročník MO, krajské B, úloha 1}{
    ...
    \Answer{Dve riešenia: $(0,0,1)$ a~$(4,2,1)$.}
...
\\EnvId{zHb1mdkxX4xBnPceHR1ud-tretie-mocniny-a-stvorce-dvojice}
\Problem{0}{57. ročník MO, celoštátne kolo A v~Česku\fnote{V~tomto ročníku bolo celoštátne aj krajské  kolo \textit{výnimočne} iné v~Česku a~na Slovensku.}, úloha 1}{
    ...
    \Answer{Tri riešenia: $(0,0)$, $(\frac{1+\sqrt{5}}{2}, \frac{1+\sqrt{5}}{2})$ a~$(\frac{1-\sqrt{5}}{2}, \frac{1-\sqrt{5}}{2})$.}
...
\EnvId{Zg7AaMLPVe_fPwcofqaP0-absolutne-hodnoty-a-mozny-sucet}
\Problem{0}{70. ročník MO, školské B, úloha 1}{
    ...
    \Answer{Súčet $x+y+z$ môže nadobúdať hodnoty $1$ a~$-3$.}
...
\EnvId{B87yKpZVrHaDr_8L0DwEk-kvadraticke-rovnice-v-kladnych-cislach}
\Problem{0}{71. ročník MO, krajské A, úloha 2}{
    ...
    \endalign
    $$
    Vidíme, že $3(x^2+2y^2) = 2(y^2+2x^2)$, z~čoho $4y^2=x^2$, teda z~kladnosti máme $2y=x$. Spätným dosadením do napr. prvej rovnice dostaneme $(2y)^2 + 2y^2 = 2(4y+y)$, teda $6y^2=10y$. Keďže je $y$ kladné, dostávame $y=5/3$ (koreň $y=0$ je kvôli kladnosti vylúčený).
    
    Dostávame tak jediné riešenie $(10/3,5/3,10/3)$, o~ktorom skúškou ľahko overíme, že vyhovuje.
}

\EnvId{6Vehj56wbxnDxAQgqTzru-tretie-mocniny-styri-nezname}
\Problem{0}{}{
    V~obore reálnych čísel riešte sústavu rovníc
    $$
    \align
    ...
    \Answer{Tri štvorice: $(0,0,0,0)$, $(\sqrt{2}, -\sqrt{2}, \sqrt{2}, -\sqrt{2})$ a~$(-\sqrt{2}, \sqrt{2}, -\sqrt{2}, \sqrt{2})$.}
...
\EnvId{6DbDwozTJMgehPjmcvRJ5-najmensie-stvormiestne-cislo-n}
\Problem{0}{}{
...
\EnvId{ABh2osL3yNL-ZxhlNa3IN-sustava-so-sucinmi-abc}
