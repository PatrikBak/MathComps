...
\Problem{0}{73-CSMO-B-II-1}{
	...
	\textit{Poznámka 1.} Bez ujmy na všeobecnosti sme od začiatku dôkazu sporom mohli predpokladať, že platí napríklad $a < b$. Potom by sme vystačili len s úvahou o trojici $bba$ vedúcej k spornému záveru $b \mid a$.
	
	\textit{Poznámka 2.} Ukážme navyše, že pre čísla $a$, $b$ spĺňajúce zadanie úlohy musí platiť buď $b = 2a$, alebo
