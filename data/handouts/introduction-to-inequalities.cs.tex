...
\EnvId{bPkLpBouOLKWsyJ2o4KB1-usporadani-soucinu-dvojic}
\Example{}{
...
\EnvId{YZmrvYRhFg_8fHlZmZo3U-nejmensi-ze-ctyr-cisel}
...
\EnvId{P4XBmJZTYVy4KIe2BPqbE-treti-mocniny-s-nezapornym-souctem}
\Example{}{
    ...
    \Answer{Rovnost nastává právě když $a+b=0$ nebo $a=b$.}
...
Zkuste si úlohy na procvičení základních rozkladů. Všimněme si, že následující cvičení je zobecněním předešlého příkladu. Zopakovat postup z~něj však nebude možné, není však těžké vymyslet něco jiného \SlightSmile{}

\EnvId{JhZA_Dzle9gA4kV4lKv9q-soucet-mocnin-dvou-kladnych-cisel}
\Exercise{}{
    ...
    \Answer{Rovnost nastává právě když $a=b$.}
...
\EnvId{mQOwqNMi8OAFVITQ-pAYo-nerovnost-pro-usporadanou-trojici}
...
\EnvId{ED7SKfRlBMObihFgvGY7A-nerovnost-pro-dve-cela-cisla}
\Problem{0}{71-CSMO-C-II-1}{
    ...
    \Answer{Rovnost nastává právě když $a=b$ nebo $b=a+1$.}
...
\EnvId{vQhiaK4eolSqnaAA9cuHZ-mocniny-a-souciny-tri-cisel}
\Example{}{
...
\\EnvId{418Wz9g6IWSugP49_tU-n-ctverce-plus-dva}
\Exercise{}{
    ...
    \Answer{Rovnost nastává právě pro $x=y=1$.}
...
\EnvId{sdg3sRT7yvoIjDcMsErsE-ctvrte-mocniny-proti-soucinu}
\Exercise{}{
    ...
    \Answer{Rovnost nastává právě pro $(a,b)=(0,0)$ nebo $(1,1)$.}
...
\EnvId{COs_bAdXRwGbPeWyYKM3R-rovnost-vyrazu-a-odhad-soucinu}
...
\EnvId{m3P8RN63DfmSb-_H94B_n-blizsi-cisla-maji-vetsi-soucin}
\Example{}{
...
\EnvId{kAB49jcHXVg3uvkhrrteu-soucin-tri-dvojicovych-souctu}
\Example{}{
...
\Example{Problém krabice}{
    ...
    \Answer{Největší objem je $128$ (krabice $8 \times 8 \times 2$).}
...
\EnvId{Fetv2ZpBpdSAL9VRNj6Bo-mocnina-a-linearni-vyraz}
\Exercise{}{
...
\EnvId{LRZ7mn998YqvFEP_vggGc-cisla-se-soucinem-jedna}
\Exercise{}{
...
\EnvId{7ptHVCux9v12DP7_YmSbY-soucet-zlomku-tri-cisel}
\Exercise{}{
    Dokažte, že pro kladná reálná čísla $a$, $b$, $c$ platí nerovnost 
    $$
...
\EnvId{5Y8zEyYvhLa8dN3Q2sEoF-ctyri-cisla-a-prevracene-hodnoty}
\Exercise{65-CSMO-A-S-2}{
    ...
    \Answer{Nejmenší hodnota $ab+cd$ je $2+2\sqrt{2}$.}
...
\EnvId{Y_rVM9PKRrNZ-xul7WWn5-dusledek-nerovnosti-s-mocninami}
\Example{}{
...
\EnvId{lGgi2UDhTRt1I5AhB-CSX-rovnost-mocnin-a-nerovnost-soucinu}
...
\EnvId{tM0NUHzGN7ISuNnwGlXCf-soucet-vetsi-nez-mocniny}
...
Nerovnosti se dají studovat ještě velmi dlouho. Existuje mnoho dalších metod, známých nerovností. Už teď jsme ale vybudovali sérii technik a postupů, které se dají použít na prakticky všechny úlohy v česko-slovenské olympiádě (včetně těch v~celostátním kole). Někdy v~dalším díle pokryjeme ještě více \SlightSmile{}
...
Různorodé úlohy, kde na všechny z~nich stačí probrané koncepty, i když jak to už u nerovností bývá, řešení bývá libovolně těžko viditelné. Hodně štěstí~\SlightSmile{}

\EnvId{DQ2FUiK5hVPMXJL4mp2Pw-nerovnost-s-odmocninou-soucinu}
\Problem{0}{}{
...
\\EnvId{h9XOWPr4I6tWgzd33zXK0-soucin-ctvercu-plus-jedna}
\Problem{0}{66-CPSJ-I-3}{
    ...
    \Answer{Rovnost nastává pro $(x,y) \in \{(2,3),(3,2),(0,-1),(-1,0)\}$.}
...
\EnvId{He5FmTiAljgyhp8e3jrZT-soucet-mocnin-a-posledni-clen}
\Problem{0}{}{
...
\EnvId{nTrt8isVP7d-IkZLcxcKy-minimum-vyrazu-se-ctvrtymi-mocninami}
\Problem{0}{70-CPSJ-I-4}{
    ...
    \Answer{Nejmenší hodnota je $-1/8$, při $x=y=1/2$.}
...
\EnvId{A8uKeAcwG40bQUQcsLUwV-podminka-se-sestou-mocninou}
