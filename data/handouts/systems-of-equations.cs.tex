...
\EnvId{D0LGFK_pfJGjGSaEZ_Hke-soustava-x2-plus-jedna}
\Example{}{
...
\EnvId{7z3zvIqJUW_wdFt8Zqo6w-trojice-x2-minus-jedna}
\Example{}{
    Metodou odčítání rovnic řešte soustavu v~množině reálných čísel:
    $$
    \align
    ...
    \Answer{Pět trojic: $(1+\sqrt2,1+\sqrt2,1+\sqrt2)$, $(1-\sqrt2,1-\sqrt2,1-\sqrt2)$, $(-1,0,0)$, $(0,-1,0)$ a~$(0,0,-1)$.}
...
\EnvId{BdBaRHPtT8T2Gs6oQNEgC-dvojice-x2-plus-xy}
\Exercise{}{
    ...
    \Answer{Dvě řešení: $(1,1)$ a~$(-1/2,-1/2)$.}
...
\EnvId{Ir2UYgurHXAHWW8PuMK7v-soucin-plus-soucet-je-tri}
\Exercise{}{
    Řešte soustavu rovnic v~oboru reálných čísel:
    $$
    \align
    ...
    \Answer{Dvě řešení: $(1,1,1)$ a~$(-3,-3,-3)$.}
...
\Exercise{58. ročník, domácí B, úloha 2}{
    ...
    \Answer{Trojice $(t,t,t)$, $(t,0,t)$ a~$(t,0,-t)$ pro libovolné reálné $t$.}
...
\EnvId{fJHAdZ9nOAf90RwGcVUgs-soustava-x2-plus-jedna-znovu}
\Example{}{
...
\EnvId{SKm6_EEO8ktWY6GLAWFK3-mocniny-rovne-soucinum}
\Example{}{
    ...
    \Answer{Trojice $(t,t,t)$ pro libovolné reálné $t$.}
...
\EnvId{ihFIU-Isi5rJX1DQF2FUp-a2-plus-b-cyklicka-soustava}
\Exercise{}{
...
\EnvId{b1Qku8TQk_bISQjaLLwJt-mocniny-rovne-ctyrnasobku}
\Exercise{}{
...
\EnvId{N916Q1M7Al6Ajy1bBzB67-nasobky-spolecneho-souctu}
\Exercise{}{
    ...
    \Answer{Dvě řešení: $(2,3,5)$ a~$(-2,-3,-5)$.}
...
\EnvId{BxI1A2IFhjVNRop0rnGmE-soustava-x2-plus-jedna-potreti}
\Example{}{
...
\EnvId{0P6L5xCu00XZL-YsyNO56-absolutni-hodnota-rozdilu-a-soucet}
...
\EnvId{hBqsEZLiptRWTxkNslZYy-treti-mocniny-plus-jedna}
\Example{}{
    Řešte soustavu v~reálných číslech:
    $$
    \align
    ...
    \Answer{Tři řešení $(t,t,t)$, kde $t \in \{1, \frac12(-1\pm\sqrt5)\}$.}
...
\EnvId{FA9H6PMOIW_BIsrkdNyJz-dvojice-rovnic-s-odmocninami}
\Exercise{}{
    V~oboru reálných čísel řešte soustavu rovnic
    $$
    \align
...
\EnvId{Er1LlMMLgP86yG2Cwg-A3-pate-mocniny-souctu}
\Exercise{}{
    Určete všechny trojice $(x,y,z)$ reálných čísel, pro které platí
    $$
    \align
    ...
    \Answer{Tři řešení: $(0,0,0)$, $(1,1,1)$ a~$(-1,-1,-1)$.}
    ...
    Zkouškou ověříme, že nalezená řešení $(0,0,0)$, $(1,1,1)$ a~$(-1,-1,-1)$ opravdu vyhovují.
}

\EnvId{wQlWW_d8RkEMYEVhPnUgM-pate-a-treti-mocniny}
\Exercise{}{
    Určete všechny trojice $(x,y,z)$ reálných čísel, pro které platí
    $$
    \align
    ...
    \Answer{Pět řešení: $(0,0,0)$, $(1,1,1)$, $(-1,-1,-1)$, $(2,2,2)$ a~$(-2,-2,-2)$.}
...
\Remark Je mnoho technik, ke kterým jsme se nedostali -- nejběžnější z~nich je využití složitějších nerovností. K~takovýmto soustavám se vrátíme v~materiálu o~nerovnostech.
...
\Problem{0}{74. ročník MO, krajské B, úloha 1}{
    ...
    \Answer{Dvě řešení: $(0,0,1)$ a~$(4,2,1)$.}
...
\\EnvId{zHb1mdkxX4xBnPceHR1ud-treti-mocniny-a-ctverce-dvojice}
\Problem{0}{57. ročník MO, celostátní kolo A v~Česku\fnote{V~tomto ročníku bylo celostátní i krajské kolo \textit{výjimečně} jiné v~Česku a~na Slovensku.}, úloha 1}{
    ...
    \Answer{Tři řešení: $(0,0)$, $(\frac{1+\sqrt{5}}{2}, \frac{1+\sqrt{5}}{2})$ a~$(\frac{1-\sqrt{5}}{2}, \frac{1-\sqrt{5}}{2})$.}
...
\EnvId{Zg7AaMLPVe_fPwcofqaP0-absolutni-hodnoty-a-mozny-soucet}
\Problem{0}{70. ročník MO, školní B, úloha 1}{
    ...
    \Answer{Součet $x+y+z$ může nabývat hodnot $1$ a~$-3$.}
...
\EnvId{B87yKpZVrHaDr_8L0DwEk-kvadraticke-rovnice-v-kladnych-cislech}
\Problem{0}{71. ročník MO, krajské A, úloha 2}{
    ...
    \endalign
    $$
    Vidíme, že $3(x^2+2y^2) = 2(y^2+2x^2)$, z~čehož $4y^2=x^2$, tedy z~kladnosti máme $2y=x$. Zpětným dosazením do např. první rovnice dostaneme $(2y)^2 + 2y^2 = 2(4y+y)$, tedy $6y^2=10y$. Jelikož je $y$ kladné, dostáváme $y=5/3$ (kořen $y=0$ je kvůli kladnosti vyloučen).
    
    Dostáváme tak jediné řešení $(10/3,5/3,10/3)$, o~kterém zkouškou snadno ověříme, že vyhovuje.
}

\EnvId{6Vehj56wbxnDxAQgqTzru-treti-mocniny-ctyri-nezname}
\Problem{0}{}{
    V~oboru reálných čísel řešte soustavu rovnic
    $$
    \align
    ...
    \Answer{Tři čtveřice: $(0,0,0,0)$, $(\sqrt{2}, -\sqrt{2}, \sqrt{2}, -\sqrt{2})$ a~$(-\sqrt{2}, \sqrt{2}, -\sqrt{2}, \sqrt{2})$.}
...
\EnvId{6DbDwozTJMgehPjmcvRJ5-nejmensi-ctyrmistne-cislo-n}
\Problem{0}{}{
...
\EnvId{ABh2osL3yNL-ZxhlNa3IN-soustava-se-souciny-abc}
\Problem{0}{64. ročník MO, celostátní kolo A, úloha 4}{
    ...
    \endalign
    $$
    To už povede ke sporu: Soustava je cyklická, stačí tedy vyřešit $a=\max\{a,b,c\}$. Potom $c-a<0$, takže z~první rovnice $b-c<0$, takže z~poslední rovnice $a-b<0$, spor.
    \enditems
