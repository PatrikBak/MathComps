...
Draw(B, D, Red);
Draw(C, E, Red);
EqualMark(B, D, color = Red);
EqualMark(C, E, color = Red);

LabeledDot(A, "A", NW, 1, offset = (0.9, 4.7), halo = true);
LabeledDot(B, "B", SW, 1);
LabeledDot(C, "C", SE, 1);
LabeledDot(D, "D", W, offset = (0, 1.9));
LabeledDot(E, "E", (1, 0));
LabeledDot(N, "N", (0, 1), offset = (1.1, 1.9));
