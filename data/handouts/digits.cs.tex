...
\Problem{0}{}{
	Je dáno přirozené číslo $n$. Určete poslední číslici čísla $n^2$, pokud víte, že předposlední číslice čísla $n^2$ je~7.
}{
...
\Problem{1}{}{
	Uvažujme následující proces: Začneme s~libovolným přirozeným číslem $a_1$ a~vygenerujeme posloupnost $a_1,a_2,\dots$ tak, že $a_{n+1}$ dostaneme z~$a_n$ přilepením číslice různé od~9 na jeho konec. Dokažte, že v~této posloupnosti bude nevyhnutelně existovat nekonečně mnoho složených čísel.
}{
