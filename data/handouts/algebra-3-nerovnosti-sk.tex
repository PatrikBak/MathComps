...
\Subtitle{Úvod do nerovností}

\Author{Patrik Bak}

\sec Úvod

Nerovnosti sú jedna zo základných tém nie len v~algebre, ale v~matematike ako takej s~veľa praktickými aplikáciami. Vezmime si napríklad takúto otázku: 
...
V~príspevku sa zamierame na najzákladnejšie postupy. Úplný základ prakticky všetkých algebier sú úpravy výrazov, tými začneme. Potom sa pozrieme na nerovnosti, ktoré využívajú kladnosť štvorcov. Následne si predstavíme známu AG nerovnosť dokonca aj s~dôkazom. Na záver si ako zaujímavosť ukážeme niekoľko netradičnejších ale stále jednoduchých úloh, kde sa šikovne používajú zaujímavé podmienky zo zadania.

\secc Základné úpravy

Veľa príkladov ide vyriešiť iba tým, že používame bežné úpravy ako roznásobovanie, rozkladanie na súčin a podobne. Takýmito úlohami začneme a~v~ďalších sekciách pridáme ďalšie už postupy.
...
\Example{}{
    ...
    Je dôležité zmieniť, že úpravy boli ekvivalentné a~postup vieme obrátiť -- v~matematike vždy vychádzame z~platných predpokladov a pomocou nich dokazujeme nové veci. Alternatívne môžeme dôkaz zapísať my obrátene, začať $(a+b)(a-b)^2 \ge 0$ a~úpravy dôjsť k~$a^3+b^3 \ge a^2b+ab^2$. To ale často vyzerá menej prirodzené než postup od dokazovanej nerovnosti k~platnému tvrdeniu s~dodatkom o~ekvivalentnosti úprav.
}
...
\Problem{0}{71-CSMO-C-II-1}{
    ...
    Po úspešnom vykonaní rozkladu by nám malo stačiť dokázať $(a-b)(a-b+1) \ge 0$, teda $k(k+1) \ge 0$. Tu musíme využiť, že $a,b$ sú celé čísla, teda ja $k$ je celé.
}{
...
\Example{}{
    ...
    \textit{Alternatívne riešenie.} Plán je preniesť si všetko na jedno stranu a pozrieť sa na nerovnosť ako na kvadratickú nerovnicu v~premennej~$a$. Potom môžeme dopĺňať na štvorec:
    $$
    \align
...
\Problem{1}{74-CSMO-A-II-1}{
    ...
    Prvý krok je odomknúť podmienku $a^3+b=a+b^3$. Presuňte všetko na ľavú stránku a~rozložte na súčin.
}{
    Z~podmienky vďaka vieme s~použitím vzorca $a^3-b^3=(a-b)(a^2+ab+b^2)$ odvodiť $(a-b)(a^2+ab+b^2-1)$, teda vďaka $a \neq b$ máme $a^2+ab+b^2=1$. Teraz skúste $a^2+b^2$ doplniť na štvorec, ide to dokonca dvoma spôsobmi.
}{
    ...
    $$
    (a+b)^2-ab = 1 \quad\text{a} (a-b)^2 + 3ab = 1.
    $$
    \begitems \style a
...
a^2+b^2 \ge 2ab,
$$
čo je dôsledkom $(a-b)^2 \ge 0$. Ukážeme, že táto jednoduchá nerovnosť sa dá zovšebecniť na niečo netriviálne.

Artimeticý priemer sa týka súčtu, geometrický súčinu. Než prezradíme presné znenie AG a jej dôkaz, predpríprava je nasledovný príklad:
...
\Example{}{
    ...
    Keďže súčet čísel je fixný, je fixný aj ich priemer. Vzdialenosť našich čísel je zrejme $2 \delta$. Čím menšia vzdialenosť, tým menšia tým, a tým väčší ich súčin $s^2-\delta^2$, čo bolo treba dokázať. 
}
...
\Theorem{AG nerovnosť}{
    ...
    Naša taktika bude nasledovná: zafixujeme súčet premenných a teda aj ich artimetický priemer~$p$ a dokážeme, že najväčší súčin majú práve vtedy, keď sú všetky rovné~$p$. Dôkaz prevedieme sporom.
    ...
    Podľa tvrdenie z~predošlého cvičenia platí, že ak tieto dve premenné priblížime k~sebe a zachávame pritom ich súčet, tak zväčšíme ich súčin, takže zväčšíme aj súčin všetkých premenných. Toto zväčšenie spravíme tak, že premennú bližšiu k~$p$ nahradíme $p$ a druhú premennú nahradíme tak, aby sa súčet zachoval. Týmto sme dosiahli, že sme zachovali súčet, zväčšili súčin, a tiež zmenšili počet premenných rôznych od $p$. Konečným opakovaním tohto algoritmu dôjdeme do stavu, kedy máme aspoň $n-1$ premených rovných $p$. 

    Ak je práve $n-1$ z~nich rovných $p$, tak hodnotu poslednej získame, keď od súčtu všetkých premenných odpočítame súčet zvyšných. Súčet všetkých je $np$ (keďže $p$ je priemer a $n$ je ich počet), zatiaľčo súčet zvyšných je $(n-1)p$ (keďže sú všetky rovné $p$). Vidíme, že aj posledná premenná musí byť rovná $p$, čo je spor.

    \textit{Poznámka.} Existuje veľmi veľa rôznych dôkazov tejto známej nerovnosti s rôznou úroveňou technickosti. Veríme však, že tejto je najintuitívnejší z~hľadiska, že najlepšie vysvetľuje, čo sa to vlastne deje.
}
...
\Example{The Box Problem}{
    ...
    \endgather
    $$
    Rovnosť nasáva práve keď všetky odhadované členy sú rovnaké, teda keď $12-2x=12-2x=4x$, čo čáva $x=2$. Potrebujeme teda vystrihnúť štvorec so stranou $x=2$ a vo výsledku dostaneme krabicu s~rozmermi $8 \times 8 \times 2$.
...
$$
platná pre kladné $a,b$. Častokrát sa objaví aj pre $b=1$, kedy znamená 
$$
a+\frac 1a \ge 2,
$$
...
\Exercise{}{
    ...
    \endgather
    $$
    Použitím nerovnost $\frac xy + \frac yx \ge 2$ na každú zátvorku potom máme
    $$
...
\Example{}{
    ...
    \textit{Poznámka.} Takto zapísané riešenie ukazuje myšlienkový postup vedúci k~riešeniu. Na súťaží by sme riešenie mohli zapísať takto:
...
Vidíme, že sme vlastne používali len veľmi jasné úvahy a rôzne ich kombinovali s~podmienkou zo zadania. Podobné hrátky je možné previesť aj v~týchto úlohách, môžete vyskúšať.
...
\Problem{0}{63-CSMO-C-II-3}{
    ...
    Dokazovaná nerovnosť je ekvivalentná s $c^2-ac+(ab-bc) \leq 0$, čo sa dá upraviť na $(c-a)(c-b) \leq 0$. Stačí teda zdôvodniť, že $c$ nie je najmenšie ani ani najväčšie číslo medzi $a,b,c$. Skúste sporom a~rozoberte dva prípady.
}{
...
a^2+b^2+c^2 \ge ab+bc+ca
$$
\i [Súčet dvoch prevrátaných hodnôt je aspoň $2$] Pre kladné $a,b$
$$
...
Záujemcom o~ďalšie štúdium odporúčam PraSe seriál Zdolávaní nerovností. Prvá kapitola je určite prístupná každému. Druhá je už trocha ťažšia (úroveň približne celoštátne kolo), rovnako aj úvod tretej. Od sekcie \uv{Tvar SOS} však začínajú síce veľmi zaujímavé ale v~dnešnej dobe nie až tak použiteľné metódy na súťažiach (kde je snaha dávať úlohy, ktoré sa nedajú \uv{zabiť} znalosťami ale sú skôr o kreativite). Rozhodne však nie je na škodu o nich vedieť.

\sec Úlohy

Rôznorodé úlohy, kde na všetky z~nich stačia prebraté koncepty, aj keď ako to už pri nerovnostiach býva, riešenie býva môže ľubovoľne ťažko viditeľné. Veľa šťastia~:)
...
$$
    ...
    Výraz $a^4+a^2b^2+b^4$ sa dá rozložiť na súčin technicou dopĺňania na štvorec, doplňte na štvorec $a^4+b^4$. Následne bude celá nerovnosť dávať zmysel.
}{
...
\Problem{0}{66-CPSJ-I-3}{
    ...
    $$
    Táto nerovnosť zjavne platí. Rovnosť nastáva, práve keď $(xy-1) - (x+y) = 0$, čiže $xy - x - y = 1$. Toto je trocha teórie čísel. Elegantné riešenie spočíta v~pripočítaní~1  k~obom stranám a~rozklade na súčin, čím dostaneme: 
    $$
    \align 
    xy - x - y + 1 &= 1 \\
    (x-1)(y-1) &= 2.
...
$$
    ...
    $$
    2 = x^2+y^6 \ge 2xy^3 \quad \text{práve keď} \quad 1 \ge xy^2,
    $$
