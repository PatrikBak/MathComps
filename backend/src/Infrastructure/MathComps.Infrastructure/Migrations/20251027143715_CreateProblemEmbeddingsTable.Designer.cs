...
namespace MathComps.Infrastructure.Migrations
{
    ...
    [Migration("20251027143715_CreateProblemEmbeddingsTable")]
    partial class CreateProblemEmbeddingsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "document_type", new[] { "problem_statement", "problem_with_solution" });
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.ProblemEmbedding", b =>
                {
                    ...
                    b.HasIndex("ProblemId", "DocumentType", "EmbeddingType", "ModelName")
                        .IsUnique()
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.ProblemEmbedding", b =>
                {
                    b.HasOne("MathComps.Domain.EfCoreEntities.Problem", "Problem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_problem_embeddings_problems_problem_id");
