...
/// preview's <see cref="DraftTextAction"/>, collapsed to the two outcomes that actually happen once validation
/// has ruled out the conflicts: a fresh row, or an in-place rewrite.
/// </summary>
...
/// <param name="ProblemsUpdated">How many existing problems were updated in place.</param>
