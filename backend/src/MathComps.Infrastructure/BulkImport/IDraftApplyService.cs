...
{
    /// <summary>
    /// Writes the draft. Upserts the taxonomy the contest path addresses — every competition down the chain, the
    ...
    /// </summary>
    /// <param name="target">The contest and season the draft lands under.</param>
