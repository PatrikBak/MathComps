...
/// bound to the requested response type out (paired with what the call billed), with transient failures retried. Each
/// call names the model it routes to; the reasoning level is optional per call.
/// </summary>
