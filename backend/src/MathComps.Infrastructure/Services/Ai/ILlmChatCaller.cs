...
/// <summary>
/// Runs a single structured chat completion against the configured OpenAI-compatible endpoint: a system message
/// plus a user message in, a reply bound to the requested response type out (paired with what the call billed),
/// with transient failures retried. Each call names the model it routes to; the reasoning level is optional per call.
/// </summary>
