...
namespace MathComps.Infrastructure.Migrations
{
    ...
    [Migration("20260913164705_AddGendersTheReaderToAttempt")]
    partial class AddGendersTheReaderToAttempt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "document_type", new[] { "hints", "solution", "statement" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "user_capability", new[] { "bypass_competition_gates" });
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.DefenseSpend", b =>
                {
                    ...
                    b.Property<bool>("CountsAgainstCeiling")
                        .HasColumnType("boolean")
                        .HasColumnName("counts_against_ceiling");
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.DefenseTurnAttempt", b =>
                {
                    ...
                    b.Property<string>("CandidateWork")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("candidate_work");
                    ...
                    b.Property<bool>("GendersTheReader")
                        .HasColumnType("boolean")
                        .HasColumnName("genders_the_reader");
                    ...
                    b.Property<string>("RestatedReferenceStep")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("restated_reference_step");
                    ...
                    b.Property<bool>("TakesOver")
                        .HasColumnType("boolean")
                        .HasColumnName("takes_over");
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.HostedGroup", b =>
                {
                    ...
                    b.ToTable("hosted_groups", null, t =>
                        {
                            t.HasCheckConstraint("ck_hosted_group_problem_count_positive", "\"problem_count\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.ProblemSelfAssessment", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "ProblemId")
                        .HasName("pk_problem_self_assessments");

                    b.HasIndex("ProblemId")
                        .HasDatabaseName("ix_problem_self_assessments_problem_id");

                    b.ToTable("problem_self_assessments", null, t =>
                        {
                            t.HasCheckConstraint("ck_problem_self_assessment_comment_carries_text", "coalesce(btrim(comment, E' \\t\\n\\r\\f'), '') <> ''");
                        });
                });
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ProfilePromptDismissedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("profile_prompt_dismissed_at");
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.UserGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<UserCapability>("Capability")
                        .HasColumnType("user_capability")
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.ProblemSelfAssessment", b =>
                {
                    b.HasOne("MathComps.Domain.EfCoreEntities.Problem", "Problem")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_problem_self_assessments_problems_problem_id");
                    ...
                    b.HasOne("MathComps.Domain.EfCoreEntities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_problem_self_assessments_users_user_id");
            ...
            modelBuilder.Entity("MathComps.Domain.EfCoreEntities.UserGrant", b =>
                {
                    b.HasOne("MathComps.Domain.EfCoreEntities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_grants_users_user_id");
