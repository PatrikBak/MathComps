...
public static class DefenseEndpoints
{
    ...
    public static void MapDefenseEndpoints(this IEndpointRouteBuilder app)
    {
            ...
            IDefenseSessionService defenseService) =>
        {
            ...
            // The request paired with the language the whole call is already localized to
            var start = new DefenseSessionStart(request, EndpointHelpers.GetRequestLanguage());
