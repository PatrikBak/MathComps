...
namespace MathComps.Shared.Linq;

/// <summary>
/// A helper class allowing to glue boolean expressions together using the 'or' conjunction.
/// </summary>
public static class PredicateBuilder
{
    ...
    public static Expression<Func<T, bool>> Or<T>(this Expression<Func<T, bool>> expression1, Expression<Func<T, bool>> expression2)
        ...
        => Expression.Lambda<Func<T, bool>>(Expression.OrElse(expression1.Body, Expression.Invoke(expression2, expression1.Parameters)), expression1.Parameters);
}
