...
/// <param name="OriginalId">The original image identifier from source TeX (e.g., "fig1.svg").</param>
...
public record ImageData(string ContentId, string OriginalId, string Width, string Height, decimal Scale);
