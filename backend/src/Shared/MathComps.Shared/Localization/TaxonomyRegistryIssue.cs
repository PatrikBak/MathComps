...
/// structural backbone (<c>metadata.shared.json</c>) or missing a localized name in one or more locale files.
...
/// <param name="MissingFromSharedStructure">True when the slug has no structural entry in metadata.shared.json.</param>
/// <param name="MissingLocales">Locales whose metadata.{locale}.json carries no localized name for the slug.</param>
