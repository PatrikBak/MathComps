    ...
    : PostgresTestBase<IProblemFilterService>(fixture)
{
    ...
    protected override async Task SeedDataAsync(MathCompsDbContext context)
    {
        ...
        context.Users.Add(new User { Id = user1Id, ExternalId = "user1", Username = "User 1", Email = "user1@example.com", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
        context.Users.Add(new User { Id = user2Id, ExternalId = "user2", Username = "User 2", Email = "user2@example.com", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow });
