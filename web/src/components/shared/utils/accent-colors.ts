...
type AccentColorClasses = {
  /** Tailwind text-color class for icons, labels, and inline accents. */
  text: string
  /** Tailwind background class for tinted pills, badges, and icon containers. */
  bg: string
  /** Tailwind group-hover text-color class for hover transitions. */
  groupHoverText: string
  /** Tailwind hover background class for interactive surfaces. */
  hoverBg: string
  /** Tailwind hover border class for interactive surfaces. */
  hoverBorder: string
  /** Tailwind hover box-shadow class for glow effects on interactive surfaces. */
  hoverGlow: string
}

/**
 * Maps each {@link AccentColor} to the exact Tailwind classes used for
 * text (icons, labels), tinted backgrounds (badges, icon pills), and
 * group-hover text transitions.
 */
